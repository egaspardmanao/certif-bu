    ...
    <div className="min-h-screen bg-slate-950 flex items-center justify-center p-4">
      <div className="w-full max-w-sm">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <h1 className="font-display font-bold text-3xl text-white">Portail Certifications</h1>
          <p className="text-slate-400 text-sm mt-1">BU Salesforce</p>
        </div>

        {sent ? (
          <div className="card p-6 text-center">
            <div className="text-3xl mb-3">📬</div>
            <h2 className="font-semibold text-white mb-2">Vérifie ta boîte mail</h2>
            <p className="text-sm text-slate-400">
              Un lien de connexion a été envoyé à <strong className="text-white">{email}</strong>.
              Clique dessus pour accéder au portail.
            </p>
            <button onClick={() => setSent(false)} className="mt-4 text-xs text-slate-500 hover:text-white">
              Changer d'adresse
            </button>
          </div>
        ) : (
          <div className="card p-6">
            <h2 className="font-semibold text-white mb-1">Connexion</h2>
